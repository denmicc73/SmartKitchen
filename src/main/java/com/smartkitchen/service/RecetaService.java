...
/**
 * Genera sugerencias de recetas a partir del inventario actual.
 *
 * Solo se envían a la IA los nombres/cantidades de los alimentos
 * (lo mínimo necesario). Nunca se envían datos de usuarios ni nada
 * fuera del inventario relevante para la receta.
 *
...
public class RecetaService {
    ...
    public RecetaService(AlimentoService alimentoService) {
